<!-- connection file and selectionquery , insertion  -->
<?php 
...
<body class="main-layout">
   ...
   <!-- loader start(after refresh loader) -->
   <div class="loader_bg">
                                 ...
                                 <div class="col-md-5">
                                    <div class="zon_text">
                                       ...
                                       <p data-animation="animated bounceInLeft">
                                          "Experience pure, organic coffee in a warm atmosphere, featuring eco-friendly
                                          practices and fresh, locally sourced ingredients for every cup."
                                       </p>
                                       <a href="about.php"><button class="btn btn-primary  read_more bounceInLeft"
                                             data-animation="animated bounceInLeft">Read More</button></a>
                                    </div>
                                 </div>
                                 <div class="col-md-7">
                                    <div class="coff_img">
